<aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <span class="app-menu__label">Developer Area</span><i class="treeview-indicator bi bi-chevron-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="users.php"><i class="icon bi bi-circle-fill"></i> Create Users </a></li>
]          </ul>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="users.php"><i class="icon bi bi-circle-fill"></i> List Users </a></li>
          </ul>
        </li>
        <ul class="app-menu">
